...
void ShapeObject::Rotate(GameScalar angle)
{
	m_rotation += angle;
...
void ShapeObject::CalcTransform(FixedTransform2D& outTransform)
{
	SinTableValue s, c;
...
void ShapeObject::UpdateAndDraw(DisplayList& displayList)
{
	if(!m_active)
	{
		return;
